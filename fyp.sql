...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2020 at 12:38 AM
...
INSERT INTO `attendance` (`stu_name`, `cour_id`, `week`, `datetime`) VALUES
('ST_075', 1, 1, '03_31_41_AM'),
('ST_104', 1, 1, '03_31_46_AM'),
('ST_075', 1, 2, 'TODAY'),
('ST_104', 2, 1, '03_31_46_AM');
...
INSERT INTO `instructor` (`teacher_id`, `teacher_name`, `teacher_pass`, `teacher_cnic`, `teacher_email`, `teacher_department`) VALUES
('IT_077', 'saad', 'saad123', '4220123342', 'muhammadsaad@gmail.com', 'Computer');
...
INSERT INTO `list` (`stu_name`, `cour_id`, `course_name`, `percent`) VALUES
('saif', 1, 'OR', '100.0'),
('saleem', 1, 'OR', '50.0'),
('saif', 2, 'CPP', '0.0'),
('saleem', 2, 'CPP', '100.0');
...
INSERT INTO `student` (`student_id`, `student_name`, `cnic`, `email`, `student_no`, `department`, `section`) VALUES
('ST_075', 'saif', 2147483647, 'saif@gmail.com', 345122933, 'Software Engineering', 'B'),
('ST_104', 'saleem', 2147483647, 'daniyal@gmail.com', 33423567, 'Software Engineering', 'B');
